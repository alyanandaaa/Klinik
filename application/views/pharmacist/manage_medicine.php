                    ...
                    <?php echo form_open('pharmacist/manage_medicine/edit/do_update/'.$row['medicine_id'] , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('stock');?></label>

                                <div class="controls">

                                    <input type="text" class="" name="stock" value="<?php echo $row['stock'];?>"/>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	...
                	<thead>
                		...
                		<tr>
                    		...
                    		<th><div><?php echo get_phrase('stock');?></div></th>
