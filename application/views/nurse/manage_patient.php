                    ...
                    <?php echo form_open('nurse/manage_patient/edit/do_update/'.$row['patient_id'] , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <label class="control-label"><?php echo get_phrase('nurse');?></label>

                                <div class="controls">

                                    <select class="chzn-select" name="nurse_id">
                                        ...
                                        ?>
                                            ...
                                            <option value="<?php echo $row['nurse_id'];?>"><?php echo $row['name'];?></option>
